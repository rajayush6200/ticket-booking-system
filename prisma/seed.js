...
async function main() {
  ...
  async function createSeatsForVenue(venue) {
    ...
    // Only create if no seats exist for this venue
  ...
  const events = [
    {
      ...
      date: '2026-09-10',
      time: '19:30',
      description: 'A mind-bending thriller by Christopher Nolan. Experience the dream within a dream in stunning quality.',
      status: 'ACTIVE',
    },
    {
  ...
  for (const ev of events) {
    ...
    if (!existing) {
      ...
      // Create ShowSeats for each seat in the venue
